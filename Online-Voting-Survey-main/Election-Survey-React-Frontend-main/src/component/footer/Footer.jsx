        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <p>👨‍💻 <strong>Developed by: AVNEET SINGH,
                                                 AKASH SINGH,
                                                </strong></p>
                    ...
                    <div className={styles.socialIcons}>
                        ...
                        <a 
                            href="https://www.linkedin.com/in/avneet-singh8740/"
                            target="_blank" 
                            rel="noopener noreferrer"
                        >
                ...
                <div className={styles.section}>
                    ...
                    <ul>
                        ...
                        <li>
                            <a 
                                href="https://github.com/avneetsingh23/Voting-Survey-React-Frontend"
                                target="_blank"
                            >
                                GitHub Repository
                            </a>
            ...
            <div className={styles.copyright}>
                ...
                <p>
                    📧 Contact: 
                    <a href="akasdevelopers@example.com">
                        <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> akasdevelopers@example.com
                    </a>
                </p>
            </div>
        </footer>
